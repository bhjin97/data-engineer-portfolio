...
export function ProjectCaseStudy({ project }: ProjectCaseStudyProps) {
  ...
  return (
    <main className="bg-white">
      ...
      <section id="problem-goal" className="scroll-mt-20 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Problem & Goal" />
      ...
      <section id="architecture" className="scroll-mt-36 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Architecture" />
        <ProjectMedia media={study.architectureImage} />
      </div></section>

      <section id="data-flow" className="scroll-mt-36 bg-slate-50 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Data Flow" subtitle="이벤트 생성부터 분석 제공까지 하나의 데이터 흐름으로 연결했습니다." />
      ...
      <section id="key-decisions" className="scroll-mt-36 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Key Decisions" subtitle="기술을 나열하기보다 각 선택이 어떤 문제를 해결했는지 설명합니다." />
      ...
      <section id="modeling" className="scroll-mt-36 bg-slate-50 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Data Modeling" subtitle="분석 목적에 맞게 데이터를 Fact · Dimension · Mart로 분리했습니다." />
      ...
      <section id="operations" className="scroll-mt-36 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Reliability & Operations" subtitle="실행하는 것에서 끝나지 않고 중단·복구·자원·모니터링까지 고려했습니다." />
      ...
      <section id="troubleshooting" className="scroll-mt-36 bg-slate-50 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Troubleshooting" subtitle="실패 원인을 추적하고 처리 책임과 운영 구조를 다시 설계했습니다." />
      ...
      <section id="validation" className="scroll-mt-36 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Validation & Performance" subtitle="설계한 데이터 흐름을 실제 부하와 쿼리로 검증했습니다." />
      ...
      <section id="next-step" className="scroll-mt-36 bg-slate-50 px-5 py-14 sm:px-8 sm:py-20"><div className="mx-auto max-w-6xl"><SectionHeader title="Limitations & Next Step" subtitle="검증 범위를 명확히 하고 다음 개선 방향을 정리했습니다." />
